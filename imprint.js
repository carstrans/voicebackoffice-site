const imprintCopy = {
  de: { title: 'Impressum — Voice Back Office', description: 'Impressum von Voice Back Office', back: '← Zur Website', privacy: 'Datenschutz' },
  ru: { title: 'Выходные данные — Voice Back Office', description: 'Выходные данные Voice Back Office', back: '← На сайт', privacy: 'Конфиденциальность' },
  uk: { title: 'Вихідні дані — Voice Back Office', description: 'Вихідні дані Voice Back Office', back: '← На сайт', privacy: 'Конфіденційність' },
  en: { title: 'Legal notice — Voice Back Office', description: 'Voice Back Office legal notice', back: '← Back to website', privacy: 'Privacy' }
};
